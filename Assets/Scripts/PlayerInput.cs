...
public class PlayerInput : MonoBehaviour {
	...
	void Update () 
	{
		if (Input.GetKeyDown (left) )	 {if (x>0.5f){ cursor.transform.localPositionTo(Constants.MoveAnimationMinDuration,new Vector3(cursor.transform.localPosition.x-1,cursor.transform.localPosition.y,0)); x-=1;}}
